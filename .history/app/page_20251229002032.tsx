...
const developers: Person[] = [
  ...
  },
  {
    ...
    stats: [
      { label: "المحور", value: "Infrastructure" }, [cite: 1, 2]
      { label: "القوة", value: "Scalability" }, 
      { label: "الأسلوب", value: "Clean Code" }, 
    ],
    accent: "emerald",
  ...
  },
  {
    ...
    // تم تخصيص صورة الفينيقي لجاسم كما طلبت
      ...
      <div className="relative z-10 grid gap-6 p-6 md:grid-cols-[180px_1fr]">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <a href={person.linkedin || "#"} target="_blank" rel="noopener noreferrer" className={cx("rounded-2xl px-4 py-2 text-sm font-semibold transition inline-block", primaryBtn)}>عرض الملف</a>
            <a href={person.email || "#"} className={cx("rounded-2xl px-4 py-2 text-sm font-semibold transition inline-block", secondaryBtn)}>تواصل</a>
