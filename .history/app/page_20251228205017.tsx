...
const developers: Person[] = [
  {
    name: "لؤي أبو جلهوم",
    role: "Backend Engineer and Team Leader",
  ...
  {
    name: "محمد خالد",
    role: "Frontend Developer with a strong intuition for AI
",
  ...
  {
    name: "عامر الحوراني",
    role: "Node.js Backend & Streaming Solutions Specialist, with experience in Mobile Development",
