...
const developers: Person[] = [
  ...
  },
  {
    ...
    [cite_start]subtitle: "أنظمة سحابية • أتمتة CI/CD • تحسين أداء [cite: 5]",
    image: "/team/mousa.jpg", 
    [cite_start]tags: ["Laravel", "Node.js", "DevOps", "Kubernetes", "AWS [cite: 5]"],
    stats: [
      [cite_start]{ label: "الخبرة", value: "+5 سنوات [cite: 5]" },
      [cite_start]{ label: "القوة", value: "Scalability [cite: 5]" },
      [cite_start]{ label: "الأسلوب", value: "Clean Arch [cite: 5]" },
    ],
    accent: "emerald",
    [cite_start]linkedin: "https://linkedin.com/in/mousa-al-halabi-9183a9237 [cite: 5]",
    [cite_start]email: "mailto:mousahlp@gmail.com [cite: 5]",
  },
  {
      ...
      <div className="relative z-10 grid gap-6 p-6 md:grid-cols-[180px_1fr]">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <a href={person.linkedin || "#"} target="_blank" rel="noopener noreferrer" className={cx("rounded-2xl px-4 py-2 text-sm font-semibold transition inline-block text-center shadow-sm cursor-pointer", primaryBtn)}>عرض الملف</a>
            <a href={person.email || "#"} className={cx("rounded-2xl px-4 py-2 text-sm font-semibold transition inline-block text-center shadow-sm cursor-pointer", secondaryBtn)}>تواصل</a>
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5">
        ...
        <div className="mt-10 text-center">
          <a 
            ...
            target="_blank"
            className="inline-flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-6 py-3 text-sm font-semibold text-white hover:bg-white/20 transition-colors shadow-lg backdrop-blur-sm cursor-pointer"
          >
            📊 عرض مخطط المعمارية
          </a>
        </div>
